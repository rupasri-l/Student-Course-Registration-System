...
export default function AddFaculty() {
  ...
  const onSubmit=async (e)=>{
    e.preventDefault();
    await axios.post("http://localhost:8080/saveFaculty",user);
    alert("Faculty is succesfully registered, to view details plz visit show all Faculty")
    navigate("/faculty")
  }
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          <h2 className="text-center m-4">Register Faculty</h2>
